...
PoissonRecon.V12.0.exe and SurfaceTrimmer.V12.0.exe depend on VC 2015 redistributable
msvcp140.dll
vcomp140.dll
vcruntime140.dll

ivcat.exe requires opengl, but we don't normally use ivcat.exe anymore
still, there is ExternalApps/opengl32-for-ivcat.dll
which gets renamed to ExternalApps/opengl32.dll by scripting
