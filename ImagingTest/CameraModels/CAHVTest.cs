    ...
    public class CAHVTest
    {
        ...
        public void TestCAHV()
        {
            ...
            for (double x = -1024; x < 1024; x += 3.3)
            {
                ...
                {
                    Ray ray = cahv.Backproject2DToRay(new Vector2(x, y));
                    ...
                    for (double r = -5; r < 20; r += 2.321)
                    {
                        ...
                        double range;
                        Vector2 pixelPos = cahv.Project3DTo2D(point, out range);
                        ...
                        Vector3 pointOther = cahv.Backproject2DTo3D(new Vector2(x, y), r);
