    ...
    public class CAHVORTest
    {
        ...
        public void TestCAHVOR()
        {
            ...
            for (double x = 0; x < 1024; x+=3.3)
            {
                ...
                {
                    Ray ray = cahvor.Backproject2DToRay(new Vector2(x,y));
                    ...
                    for (double r = 0.5; r < 20; r += 2.321)
                    {
                        ...
                        double range;
                        Vector2 pixelPos = cahvor.Project3DTo2D(point, out range);
                        ...
                        Vector3 pointOther = cahvor.Backproject2DTo3D(new Vector2(x, y), r);
