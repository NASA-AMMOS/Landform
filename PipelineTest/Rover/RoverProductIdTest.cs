...
namespace PipelineTest
{
    ...
    public class RoverProductIdTest
    {
        ...
        {
            var id = RoverProductId.ParseFromString("NLB_436643735RASLF0220000NCAM00323M_.IMG");
            ...
            id = RoverProductId.ParseFromString("0608ML0025660260301542E01_DRCX.IMG");
