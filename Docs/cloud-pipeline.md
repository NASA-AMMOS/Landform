...
1.  Create an s3 bucket that will hold the data products, e.g. `s3://landlords-dev/landform-USERNAME`.  Upload your inputs file there.
1.  Build Landform in visual studio in release mode.
1.  `cd Landform/bin/Release`
1.  `Landform.exe configure-cloud --nouserdata`
