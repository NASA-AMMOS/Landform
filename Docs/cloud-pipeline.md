...
6. `Landform.exe start-align-master PROJ [--inputpath=INPUT] [--debugoutputfolder=DBG] [--startworker] [--verbose] [--redoproject] [--redoobservations] [--redopriors] [--redomasks] [--redofeatures] [--redooverlaps] [--redomatches] [--skipmatching] [--skipbundleadjust] [--matchwithinsitedrives={true|false}] [--adjustwithinsitedrives={true|false}] [--adjustacrosssitedrives={true|false}] [--bundleadjustrounds=2]` where
