...
2.  Create an s3 bucket that will hold the alignment data products, e.g. `s3://landform-align-USERNAME`.  Upload your inputs file there.
...
5.  `Landform.exe configure-cloud --nouserdata`
    ...
    * S3 url: use the s3 bucket you created above, e.g. `s3://landform-align-USERNAME`
