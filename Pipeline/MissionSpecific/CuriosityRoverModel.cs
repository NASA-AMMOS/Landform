...
namespace JPLOPS.Pipeline
{
    ...
    public class CuriosityRoverModel : RoverModel
    {
        ...
        public Mesh BuildMesh(MSLRoverArticulation pose, bool includeBody = true)
        {
            ...
            if (includeBody)
            {
                res = MeshMerge.Merge(Body, leftRocker, leftBogie, rightRocker, rightBogie, arm);
            }
            else
            {
                res = MeshMerge.Merge(leftRocker, leftBogie, rightRocker, rightBogie, arm);
            }
        ...
        private Mesh BuildArm(MSLRoverArticulation pose)
        {
            ...
            return MeshMerge.Merge(arm1, arm2, arm3, arm4, arm5);
        }
