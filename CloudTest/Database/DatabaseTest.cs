...
namespace CloudTest
{
    ...
    public class DatabaseTest
    {
        ...
        {
            DynamoDBContext context = DBUtil.MakeContext("dev0-");
            ...
            Assert.AreEqual(5, DBUtil.Scan<Frame>(context, new ScanCondition("ProjectName", ScanOperator.Equal, project)).Count()
                            + DBUtil.Scan<Frame>(context, new ScanCondition("ProjectName", ScanOperator.Equal, project2)).Count()); //check for both project names
