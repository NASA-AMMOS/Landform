...
# Runs process-tactical as a service on an EC2 instance.
#
...
eval "$landform configure --venue=tactical-service $quiet"

while true; do
  eval "$landform process-tactical --stacktraces --service $quiet"
  sleep 30
done
