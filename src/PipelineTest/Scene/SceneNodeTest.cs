...
namespace PipelineTest
{
    public class LazyMatrixTest
    {
        ...
        public void ChangeParent()
        {
            ...
            Assert.Equal(Matrix.Identity, n2.Transform.LocalToWorld);
        ...
        public void MoveDeepParent()
        {
            ...
            Assert.True(newTransform.AlmostEqual(expected));
        }
        ...
        public void TRSOrder()
        {
            ...
            for (int i = 0; i < 1000; i++)
            {
                ...
                Assert.True(node.Transform.LocalToWorld.AlmostEqual(
        ...
        public void StochasticTreeShuffle()
        {
            ...
            for (int i = 0; i < 2000; i++)
            {
                ...
                Assert.True(TransformStateValid(root.Transform, recursive: true));
            }
        }
