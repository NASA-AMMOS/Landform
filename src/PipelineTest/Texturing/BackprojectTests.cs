...
namespace PipelineTest
{
    public class BackprojectTests
    {
        ...
        public void FillIndexImageTest()
        {
            ...
            string filename1 = "ML0_451292526RCX_S0311094MCAM02555M1.IMG";
            string filename2 = "NLB_451557756RASLF0311330NCAM00353M1.IMG";
            ...
            //validate output
            Assert.True(outputImage[0, 0, 0] == 0 && outputImage[1, 0, 0] == 0 && outputImage[2, 0, 0] == 0);
            Assert.True(outputImage[0, 0, 1] == 1 && outputImage[1, 0, 1] == 45 && outputImage[2, 0, 1] == 34);
            Assert.True(outputImage[0, 1, 0] == 2 && outputImage[1, 1, 0] == 78 && outputImage[2, 1, 0] == 56);
            Assert.True(outputImage[0, 1, 1] == 0 && outputImage[1, 1, 1] == 0 && outputImage[2, 1, 1] == 0);
        ...
        public void FillOutputTextureTest()
        {
            ...
            Assert.Equal(outputImage.Width * outputImage.Height, stats.BackprojectedSurfacePixels);
            Assert.Equal(0, stats.BackprojectedOrbitalPixels);
            Assert.Equal(0, stats.BackprojectMissingPixels);
            ...
            for (int idxRow = 0; idxRow < 64; idxRow++)
            {
                for (int idxCol = 0; idxCol < 64; idxCol++)
                {
                    ...
                    {
                        Assert.True(outputImage[idxBand, idxRow, idxCol] == img1[idxBand, idxRow, idxCol]);
                        Assert.True(outputImage[idxBand, idxRow, idxCol + 64] == img2[0, idxRow, idxCol]);
                    }
                }
            }
        }
