...
namespace JPLOPS.ImageFeatures
{
    public class FASTDetector : FeatureDetectorBase
    {
        ...
        public FastFeatureDetector.DetectorType DetectorType = FastFeatureDetector.DetectorType.Type9_16;
        public int DescriptorSize = 64; //16, 32, or 64

        public override Feature2D MakeDetector()
        {
            return new FastFeatureDetector(Threshold, NonMaxSuppression, DetectorType);
        }
