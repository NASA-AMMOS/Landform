...
namespace JPLOPS.Cloud
{
    ...
    public class MessageQueue : IDisposable
    {
                            ...
                            bool landformOwned = true, bool autoTypes = true, bool autoCreateIfLandformOwned = true)
        {
            ...
            try
            {
                url = client.GetQueueUrlAsync(name).GetAwaiter().GetResult().QueueUrl;
                ...
                var res = client.GetQueueAttributesAsync(req).GetAwaiter().GetResult();
                ...
                if (res.VisibilityTimeout != timeoutSec)
                {
                    ...
                    if (landformOwned)
                    {
                        ...
                        client.SetQueueAttributesAsync(url, attrs).GetAwaiter().GetResult();
                    }
                    else
                    {
            ...
            catch (QueueDoesNotExistException)
            {
                if (landformOwned && autoCreateIfLandformOwned)
                {
                    ...
                    url = client.CreateQueueAsync(req).GetAwaiter().GetResult().QueueUrl;
                }
                else
                {
                    throw;
        ...
        public void Purge()
        {
            client.PurgeQueueAsync(url).GetAwaiter().GetResult();
        }
        ...
        public void Enqueue(string message)
        {
            ...
            client.SendMessageAsync(req).GetAwaiter().GetResult();
        }
        ...
        {
            client.ChangeMessageVisibilityAsync(new ChangeMessageVisibilityRequest(url, messageHandle, timeoutSec)).GetAwaiter().GetResult();
        }
                              ...
                              Func<string, QueueMessage> altHandler = null) where T : class
        {
            ...
            try
            {
                msgs = client.ReceiveMessageAsync(req).GetAwaiter().GetResult().Messages;
            }
        ...
        {
            client.DeleteMessageAsync(new DeleteMessageRequest { QueueUrl = url, ReceiptHandle = receiptHandle }).GetAwaiter().GetResult();
        }
        ...
        public static bool QueueExists(AmazonSQSClient client, string name)
        {
            try
            {
                client.GetQueueUrlAsync(name).GetAwaiter().GetResult();
                return true;
            }
            catch (QueueDoesNotExistException)
            {
        ...
        public static bool DeleteQueue(AmazonSQSClient client, string name)
        {
            try
            {
                client.DeleteQueueAsync(client.GetQueueUrlAsync(name).GetAwaiter().GetResult().QueueUrl).GetAwaiter().GetResult();
                return true;
            }
            catch (QueueDoesNotExistException)
            {
