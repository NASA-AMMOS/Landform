...
const development = {
  app: {
    ...
    venue: env.LANDFORM_VENUE_NAME || `landformweb-dev-${os.userInfo().username}-${os.hostname()}`,
...
integration.app.venue = env.LANDFORM_VENUE_NAME || 'landformweb-dev';
...
production.app.venue = env.LANDFORM_VENUE_NAME || 'landformweb';
