...
namespace Microsoft.Xna.Framework
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        {
            //CustomExtension added exception
            double dist = Math.Sqrt((X * X) + (Y * Y));
            if(dist == 0) {
                throw new DivideByZeroException();
            }
			double val = 1.0f / dist;
			X *= val;
			Y *= val;
        }
        ...
        {
            //CustomExtension added exception
            double dist = Math.Sqrt((value.X * value.X) + (value.Y * value.Y));
            if(dist == 0) {
                throw new DivideByZeroException();
            }
			double val = 1.0f / dist;
        ...
        private static Vector2 smallestVector = new Vector2(double.MinValue);
        private static Vector2 largestVector = new Vector2(double.MaxValue);
        public double U
        {
            get { return X; }
            set { X = value; }
        ...
        public static Vector2 Smallest
        {
            get { return smallestVector; }
        }
        public static Vector2 Largest
        {
            get { return largestVector; }
        }
        public static bool AlmostEqual(Vector2 a, Vector2 b, double eps = MathHelper.Epsilon)
        {
