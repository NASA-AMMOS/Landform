...
namespace Microsoft.Xna.Framework
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
		...
		internal static void ToMatrix(Quaternion quaternion, out Matrix matrix)
		{
            ...
            matrix.M41 = 0;// 2.0f * (xz - wy);
            matrix.M42 = 0;//2.0f * (yz + wx);
            matrix.M43 = 0;//1.0f - 2.0f * (x2 + y2);
            matrix.M44 = 1;// 0.0f;
        ...
        public static bool AlmostEqual(Quaternion a, Quaternion b, double eps = MathHelper.Epsilon)
        {
