...
namespace Microsoft.Xna.Framework
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        {
            // Hashcode implementation based on guidance in Effective Java by Joshua Bloch.
            int hash = 17;
            hash = 37 * hash + this.X.GetHashCode();
            hash = 37 * hash + this.Y.GetHashCode();
            hash = 37 * hash + this.Z.GetHashCode();
            return hash;
        }
        ...
        /// <summary>
        /// Note that Vectors in XNA are treated as row vectors and are are placed on
        /// the left hand side of the multiplication v*M.  When converting equations
        /// originally designed for column vectors which get multipled on the right
        /// side of the equation, you must transpose the matrix to get the desired result.
        /// </summary>
...
//        }
        ...
        private static Vector3 smallestVector = new Vector3(double.MinValue);
        private static Vector3 largestVector = new Vector3(double.MaxValue);
        public double R
        {
            get { return X; }
            set { X = value; }
        ...
        public static Vector3 Smallest
        {
            get { return smallestVector; }
        }
        public static Vector3 Largest
        {
            get { return largestVector; }
        }
        public static bool AlmostEqual(Vector3 a, Vector3 b, double eps = MathHelper.Epsilon)
        {
