...
namespace Microsoft.Xna.Framework
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        public static void Normalize(ref Vector4 vector, out Vector4 result)
        {
            ...
            // CustomExtension added extension
            if (factor == 0)
            {
        ...
        private static Vector4 smallestVector = new Vector4(double.MinValue);
        private static Vector4 largestVector = new Vector4(double.MaxValue);
        public double R
        {
            get { return X; }
            set { X = value; }
        ...
        public static Vector4 Smallest
        {
            get { return smallestVector; }
        }
        public static Vector4 Largest
        {
            get { return largestVector; }
        }
        public static bool AlmostEqual(Vector4 a, Vector4 b, double eps = MathHelper.Epsilon)
        {
